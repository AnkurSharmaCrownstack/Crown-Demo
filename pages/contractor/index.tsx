...
import { PhotoIcon, UserCircleIcon as UserCircleIconOutline } from '@heroicons/react/24/solid';
const navigation = [
         ...
         <div className="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8 justify-start">
          {products1.map((product) => (
           <a
            key={product.id}
            href={product.href}
            className="group justify-start content-start text-start"
           >
            <div className="aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-lg justify-start content-start">
             <img
              src={product.imageSrc}
              alt={product.imageAlt}
              className="h-full object-contain group-hover:opacity-75"
             />
            </div>
